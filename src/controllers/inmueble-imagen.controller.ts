...
export class InmuebleImagenController {
  ...
  async find(
    ...
    return this.inmuebleRepository.InmuebleImagen(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.InmuebleImagen(id).create(imagen);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.InmuebleImagen(id).patch(imagen, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.InmuebleImagen(id).delete(where);
  }
}
