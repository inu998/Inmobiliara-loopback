...
export class PropietarioInmuebleController {
  ...
  async find(
    ...
    return this.propietarioRepository.inmueblepropietario(id).find(filter);
  }
  ...
  async create(
    ...
    return this.propietarioRepository.inmueblepropietario(id).create(inmueble);
  }
  ...
  async patch(
    ...
    return this.propietarioRepository.inmueblepropietario(id).patch(inmueble, where);
  }
  ...
  async delete(
    ...
    return this.propietarioRepository.inmueblepropietario(id).delete(where);
  }
}
